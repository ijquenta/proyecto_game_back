...
parseCreateSesion.add_argument('fecha_sesion', type=str, required=True, help='Ingrese la fecha de la sesión')
...
parseCreateSesion.add_argument('mejoras_observadas', type=str, required=True, help='Ingrese las mejoras observadas')
parseCreateSesion.add_argument('feedback', type=str, required=True, help='Ingrese el feedback' )
parseCreateSesion.add_argument('notas', type=str, required=True, help='Ingrese las notas')
parseCreateSesion.add_argument('resultados_prueba', type=str, required=True, help='Ingrese los resultados de las pruebas')
parseCreateSesion.add_argument('estado', type=str, required=True, help='Ingrese el estado')
...
parseUpdateSesion.add_argument('mejoras_observadas', type=str, required=True, help='Ingrese las mejoras observadas')
parseUpdateSesion.add_argument('feedback', type=str, required=True, help='Ingrese el feedback' )
parseUpdateSesion.add_argument('notas', type=str, required=True, help='Ingrese las notas')
parseUpdateSesion.add_argument('resultados_prueba', type=str, required=True, help='Ingrese los resultados de las pruebas')
parseUpdateSesion.add_argument('estado', type=str, required=True, help='Ingrese el estado')
