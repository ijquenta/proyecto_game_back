...
SQLALCHEMY_DATABASE_URL = os.getenv('SQLALCHEMY_DATABASE_URL','postgresql://admin:123456@localhost:5432/db_academico')
# SQLALCHEMY_DATABASE_URL = os.getenv('SQLALCHEMY_DATABASE_URL','postgresql://postgres:yFnqNwRDqSaHmpvEVQnlsmWNpkHzYNrh@viaduct.proxy.rlwy.net:48498/railway')
