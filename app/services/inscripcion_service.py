...
def listarInscripcion():
    return select(f'''
    SELECT i.insid, i.matrid, m.matrgestion, m.matrestado , m.matrestadodescripcion , i.peridestudiante, p.pernombrecompleto, i.pagid,
    p2.pagdescripcion, p2.pagestado, p2.pagestadodescripcion, p2.pagmonto, i.insusureg, i.insfecreg, i.insusumod, i.insfecmod, i.curmatid, i.insestado
